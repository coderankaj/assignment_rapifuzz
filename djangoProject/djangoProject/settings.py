...
#         'USER': config('DATABASE_USER'),  # Replace with your database user
#         'PASSWORD': config('DATABASE_PASSWORD'), # Replace with your database password
#         'HOST': config('DATABASE_HOST'), # Or your database host
#         'PORT': config('DATABASE_PORT'),  # Default MySQL port
#     }
# }
